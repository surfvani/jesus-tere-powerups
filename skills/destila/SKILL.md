...
- **Entradas fijas:** Cualquier variante fonética en los transcripts de los nombres de Jesús y de Tere → sus nombres canónicos ⚠️ (PENDIENTE: Marc debe fijar aquí los nombres completos de ambos). También: cualquier variante fonética de «Marc Jovani» (Marc Giovanni, Mark Giovanni, Mar Giovanni, Mark Chauvin, Mark Chobani, etc.) → **Marc Jovani**. Aplícalas en silencio; no las marques.
